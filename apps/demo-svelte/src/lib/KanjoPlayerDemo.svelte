<script lang="ts">
      ...
      customButtons: {
        ...
        buttons: [
          ...
          },
          {
            ...
            text: { en: 'Share', es: 'Compartir', fr: 'Partager', de: 'Teilen', ja: '共有', zh: '分享', zhTW: '分享', ko: '공유' },
  ...
  function handleLanguageChange(e: Event) {
    ...
    if (player && locale) {
      player.locale.update(locale, selectedLanguage)
    }
  }
...
<div class="video-player-container">
  <div class="controls-bar">
    ...
    <div class="language-selector">
      <label for="language-select">Player Language:</label>
